...
## القراءة التلقائية لكل رد

إعداد `audio.autoSpeakReplies` مفعّل افتراضيًا. بعد اكتمال أي رد جديد في المحادثة أو المساعد العام أو بطاقات نتائج الذكاء في الصفحات، يرسله التطبيق إلى مسار `/api/ai/tts` ويشغله بصوت Alloy تلقائيًا. بدء رد جديد يوقف الصوت السابق لمنع التداخل، ويمكن تعطيل السلوك من الإعدادات مع بقاء زر الاستماع اليدوي متاحًا.
